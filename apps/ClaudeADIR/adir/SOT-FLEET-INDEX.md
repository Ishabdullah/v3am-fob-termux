...
> ⚠️ **BEFORE EDITING THIS FILE:** Make a dated backup first.
> Backup exists at: `SOT-FLEET-INDEX-BACKUP-20260322.md` — do not delete until you're confident in the current version.
> This file must be **manually updated** after every KB-Maker or Agent-Dropper deploy. Agents may overwrite or drift this content — when in doubt, create a new dated SOT file rather than editing this one.
> Naming convention: `SOT-FLEET-INDEX.md` is always the live copy. Backups: `SOT-FLEET-INDEX-BACKUP-YYYYMMDD.md`
...
**Last verified:** 2026-03-22 — Launcher4 clean run: 21/22 UP (SD WebUI DOWN — expected, D:\AIScreen not present)
...
| TEMPLATE-TANDRSOCIAL-v2 | 57790 | `adirhub\TOOLS\TEMPLATE-TANDRSOCIAL-v2` | **Running as TANDRSocial Production Server** — in Launcher4 as of 2026-03-22 |
